// The ZIP builder accepts only this reviewed, passive stylesheet byte-for-byte.
// Keep src/static/archive.css identical; the asset contract test enforces it.
export const ARCHIVE_CSS = `:root {
  color-scheme: light;
